...
de départ pour notre recherche \endnote{Vidéo, DAVID LOUAPRE, 06/10/2023: 
\url{https://www.youtube.com/watch?v=ewc8FBtEKPs&t=1336s&ab_channel=VikingRise}}. 
\vspace{\baselineskip}
...
($N_2O$) et les gaz fluorés (HFC) \endnote{Article, JEAN-MARC JANCOVICI, 01/08/2007:
...
\makeatletter
\renewcommand{\enoteheading}{\par\vspace{1em}}
\renewcommand{\theenmark}{\makebox[0.5em][r]{\@theenmark}}
\renewcommand{\enoteformat}{\parindent=2em
  							\leftskip=1em
