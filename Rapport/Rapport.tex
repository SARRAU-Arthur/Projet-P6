...
phi = intégrale (émittance) dlambda 
...
On a : (1-tauxCO2) = INTEGRALE ((kabs*nCo2(z))dz))

Exprimons nCO2 en fonction de l’altiude, pour cela il nous faut des profils de température qui dépendent de l’altitude : 
