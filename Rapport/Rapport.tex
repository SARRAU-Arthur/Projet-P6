...
\begin{description}
    ...
    \item[\boldmath{$E_\lambda$}] Émittance spectrique du Soleil ($W.m^{-3}$)
...
$\sigma T^4$ = $\frac{1}{2} \int_{\lambda}^{} (1-\tau_{CO_2})M^{0}_\lambda (T) \, \mathrm{d}z 
                + \bar{a_T} \int_{\lambda}^{} \tau_{CO_2}E_\lambda (T) \, \mathrm{d}z$ \vspace{\baselineskip}
