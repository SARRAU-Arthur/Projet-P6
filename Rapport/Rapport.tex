...
\put(240,0){\color{INSA_GM}{\begin{minipage}{12cm}\centering \Large % Caractéristiques projet haut droit
	\textbf{Projet de Physique P6} \\ 
	\textbf{STPI/P6/2024-\#\#\#}\end{minipage}}}
\put(-20,-150){\color{INSA_BLEU}{\begin{minipage}{\textwidth}\centering \Huge % Titre princpal rapport
...
\put(0,60){\color{INSA_GRIS}{\begin{minipage}{6cm}
	Anouk PETIGAS  \\ Clara MÉLINE \\ Romane LANÈRES \end{minipage}}}
\put(185,60){\color{INSA_GRIS}{\begin{minipage}{6cm}
	Arthur SARRAU \\ Nina ZEDDOUN \\ Tom PHILIPPE \end{minipage}}}
